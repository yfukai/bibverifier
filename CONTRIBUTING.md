...
Welcome to the contributor guide of Bibverifier.
...
If you experience bugs or general issues with Bibverifier, please have a look
...
You can help improve the documentation of Bibverifier by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/bibverifier.git
   cd bibverifier
   ```
